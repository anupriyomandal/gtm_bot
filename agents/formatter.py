...
3. Keep all data values, numbers, and existing Slack formatting exactly as-is
4. Do not rewrite, reorder, summarize, or truncate the body — only add the summary header and ⚠️ markers where genuinely appropriate
5. IMPORTANT: always use single asterisks for bold (*text*), never double asterisks (**text**) — this is Slack mrkdwn not markdown"""
